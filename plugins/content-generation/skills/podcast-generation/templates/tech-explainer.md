...
python ./scripts/generate.py \
  --script-file <sandbox-dir>/workspace/tech-explainer-script.json \
  --output-file <sandbox-dir>/outputs/tech-explainer-podcast.mp3 \
  --transcript-file <sandbox-dir>/outputs/tech-explainer-transcript.md
```
