...
- **File location**: Path(s) to uploaded Excel/CSV files in `<upload-dir>/`
...
- On first load, files are parsed and stored in a persistent DuckDB database under `<sandbox-dir>/.cache/`
